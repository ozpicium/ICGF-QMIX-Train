...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        #---------------------------------
        # Add rewards for moving to strategic points.
        self.reward_StrategicPoint_val = 100
        ...
        self.max_reward = (
            self.n_enemies * self.reward_death_value + self.reward_win + self.reward_StrategicPoint_val
        )
    ...
    def reward_battle(self):
        ...
        if self.reward_only_positive:
            ...
            reward = abs(delta_enemy + delta_deaths)# + reward_ReachStrategicPoints  # shield regeneration
            ...
            reward = delta_enemy + delta_deaths - delta_ally# + reward_ReachStrategicPoints
        return reward
