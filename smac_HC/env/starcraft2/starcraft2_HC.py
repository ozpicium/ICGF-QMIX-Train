...
class StarCraft2Env_HC(MultiAgentEnv):
    ...
    def get_state_company(self):
        ...
        for pid in self.ally_platoons:
            for al_id, al_unit in enumerate(pid):
                ...
                if al_unit.health > 0:
                    ...
                    ally_state[al_id, 3] = (
                                                   y - center_y
                                           ) / self.max_distance_y  # relative Y''' ##removed by SHUBHAM -- use lcoation-invariant state
        ...
        for e_id, e_unit in self.enemies.items():
          ...
          if add_this_enemy:
              ...
              enemy_state[idx, 2] = (
                                             y - center_y
                                     ) / self.max_distance_y  # relative Y''' ##removed by SHUBHAM -- use lcoation-invariant enemy state
    ...
    def init_platoons(self):
        ...
        while True:
            ...
            self.eid_to_attack = [[] for _ in range(n_ally_platoons)] #SHUBHAM
